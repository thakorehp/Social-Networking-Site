...
channel_routing = [
    ...
    include("marvel.routing.websocket_routing", path=r"^/chat/stream"),
    include("marvel.routing.websocket_routing", path=r"^/chat/notification"),
    ...
    include("marvel.routing.custom_routing"),
